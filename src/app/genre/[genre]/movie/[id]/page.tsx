    ...
    <>
      ...
      <div className="relative">
        <img
          ...
          className="w-full object-cover h-[30rem] md:h-[30rem] lg:h-auto"
        />
        <div className="bg-black absolute bottom-0 w-full h-[20rem] blur-[30rem]" />

        {/* Movie info section */}
        <div className="absolute bottom-[3rem] left-4 w-[90%]">
          <div className="flex flex-col md:flex-row items-start gap-6 md:gap-12">
            ...
            <div className="text-white max-w-full md:max-w-[60%] flex flex-col gap-3">
              <h2 className="lg:text-[3rem] text-[2rem] font-bold">{result.title}</h2>
              <p className="text-sm md:text-base text-gray-200">
                {new Date(result.release_date).getFullYear()} • {result.runtime} mins
              </p>
            ...
            {/* <div className='flex items-center gap-[.5rem] absolute bottom-0 right-0'>
                 <div className='bg-red-400 p-[1rem] rounded-[.5rem] cursor-pointer'>
                     <FaPlay color='#fff' className='text-[1.7rem] text-white' />
                 </div>

                   <div className='bg-red-400 p-[1rem] rounded-[.5rem] cursor-pointer'>
                     <FaDownload color='#fff' className='text-[1.7rem] text-white' />
                 </div>

                   <div className='bg-red-400 p-[1rem] rounded-[.5rem] cursor-pointer'>
                     <FaShare color='#fff' className='text-[1.7rem] text-white' />
                 </div>
            </div> */}
          </div>
        </div>
