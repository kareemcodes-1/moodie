...
const MoviesHero = ({ result, videos }: Props) => {
  ...
  return (
    <div className="relative">
      ...
      />
      <div className="inset-0 bg-black/70 absolute lg:top-[0rem] bottom-[7rem] w-full lg:h-[100vh] h-[20rem] lg:backdrop-blur-[30rem] backdrop-blur-[15rem]" />
